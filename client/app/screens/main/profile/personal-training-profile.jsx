    ...
    return (
        <View style={styles.main}>
            ...
            <AppScroll extraBottom={20}>
                <TouchableOpacity onPress={() => router.push(routes.PERSONAL_TRAINING_EXPLANATION)} style={styles.card}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Image source={Images.noHelp} style={{ tintColor: 'white', width: 35, height: 35, marginEnd: 10 }} />
                            <View>
                                <AppText style={{ fontWeight: 'bold', color: 'white', fontSize: scaleFont(15) }}>What is training profile?</AppText>
                                <AppText style={{ fontWeight: 'bold', color: colors.mutedText, fontSize: scaleFont(12) }}>Tap to learn more</AppText>
                            </View>
                        </View>
                        <Image source={Images.arrow} style={{ tintColor: 'white', width: 20, height: 20, marginStart: 10 }} />
                    </View>
                </TouchableOpacity>
                <View style={[styles.card, {padding: 15, marginTop: 15}]}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        <AppText style={{ fontWeight: 'bold', color: 'white', fontSize: scaleFont(15) }}>Trainer Status</AppText>
                        <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <View style={{ padding: 10, borderTopLeftRadius: 10, borderBottomLeftRadius: 10, backgroundColor: user.isTrainer ? colors.main : colors.backgroundSecond }}>
                                <AppText style={{ color: 'white' }}>On</AppText>
                            </View>
                            <View style={{ padding: 10, borderTopRightRadius: 10, borderBottomRightRadius: 10, backgroundColor: colors.main }}>
                                <AppText>Off</AppText>
                            </View>
                        </TouchableOpacity>
                    </View>
