...
export const exercises = [
    ...
    { id: "ex_231", label: "Incline Smith Machine Close Grip Press", muscleGroups: ["Chest", "Upper Chest"], type: "compound", equipment: "Smith Machine / Bench", mechanic: "push", level: "intermediate", isBodyweight: false, kCalBurned: 7, instructions: "Lie on incline bench, grip bar narrower than shoulders, press upward focusing on upper chest." },
    { id: "ex_232", label: "Incline Cable Crossover", muscleGroups: ["Chest", "Upper Chest"], type: "isolation", equipment: "Cable Machine", mechanic: "push", level: "intermediate", isBodyweight: false, kCalBurned: 6, instructions: "Set cables low, cross hands at chest level, squeeze chest at the top." },
    { id: "ex_233", label: "Incline Hammer Grip Dumbbell Press", muscleGroups: ["Chest", "Upper Chest"], type: "compound", equipment: "Dumbbells / Bench", mechanic: "push", level: "intermediate", isBodyweight: false, kCalBurned: 7, instructions: "Palms facing each other, press dumbbells from chest to overhead, focus on upper chest contraction." },
    { id: "ex_234", label: "Machine Incline Press", muscleGroups: ["Chest", "Upper Chest"], type: "compound", equipment: "Chest Press Machine", mechanic: "push", level: "beginner", isBodyweight: false, kCalBurned: 6, instructions: "Adjust seat to incline, press handles upward until arms are extended, control return." },
    { id: "ex_235", label: "Incline Dumbbell Reverse Fly", muscleGroups: ["Chest", "Upper Chest", "Rear Delts"], type: "isolation", equipment: "Dumbbells / Bench", mechanic: "pull", level: "intermediate", isBodyweight: false, kCalBurned: 5, instructions: "Lie chest down on incline bench, open arms to side with slight bend, squeeze shoulder blades." },
    { id: "ex_236", label: "Incline Plate Press", muscleGroups: ["Chest", "Upper Chest"], type: "compound", equipment: "Weight Plate / Bench", mechanic: "push", level: "intermediate", isBodyweight: false, kCalBurned: 7, instructions: "Hold a weight plate with both hands, press upward over chest from incline bench, lower slowly." },
    { id: "ex_237", label: "Incline Dumbbell Around the World", muscleGroups: ["Chest", "Upper Chest"], type: "isolation", equipment: "Dumbbells / Bench", mechanic: "push", level: "intermediate", isBodyweight: false, kCalBurned: 6, instructions: "Lie on incline bench, move dumbbells in wide arc from sides to above chest, keep elbows slightly bent." },
    { id: "ex_238", label: "Incline Push-Up with Feet Elevated", muscleGroups: ["Chest", "Upper Chest"], type: "compound", equipment: "Bodyweight / Bench", mechanic: "push", level: "beginner", isBodyweight: true, kCalBurned: 5, instructions: "Hands on floor, feet elevated on bench, perform push-ups focusing on upper chest contraction." },
    { id: "ex_239", label: "Incline Landmine Chest Press", muscleGroups: ["Chest", "Upper Chest"], type: "compound", equipment: "Landmine / Barbell", mechanic: "push", level: "intermediate", isBodyweight: false, kCalBurned: 6, instructions: "Stand or kneel at incline angle to landmine, press bar up and forward, squeeze upper chest." },
    { id: "ex_240", label: "Incline Dumbbell Isometric Hold Press", muscleGroups: ["Chest", "Upper Chest"], type: "compound", equipment: "Dumbbells / Bench", mechanic: "push", level: "advanced", isBodyweight: false, kCalBurned: 7, instructions: "Press dumbbells up on incline bench and hold at mid-height for several seconds, then lower slowly." },
    { id: "ex_241", label: "Hanging Leg Raise", muscleGroups: ["Abs", "Core"], type: "isolation", equipment: "Pull-Up Bar", mechanic: "pull", level: "intermediate", isBodyweight: true, kCalBurned: 6, instructions: "Hang from bar, lift legs to 90°, control descent." },
    { id: "ex_242", label: "Ab Wheel Rollout", muscleGroups: ["Abs", "Core"], type: "isolation", equipment: "Ab Wheel", mechanic: "hinge", level: "advanced", isBodyweight: true, kCalBurned: 7, instructions: "Kneel, roll wheel forward, extend torso, then return slowly." },
    { id: "ex_243", label: "Cable Crunch", muscleGroups: ["Abs", "Core"], type: "isolation", equipment: "Cable Machine", mechanic: "hinge", level: "intermediate", isBodyweight: false, kCalBurned: 5, instructions: "Kneel, hold cable behind head, crunch down squeezing abs." },
    { id: "ex_244", label: "Pull-Up", muscleGroups: ["Back", "Lats"], type: "compound", equipment: "Pull-Up Bar", mechanic: "pull", level: "intermediate", isBodyweight: true, kCalBurned: 8, instructions: "Grip bar, pull chest toward bar, lower slowly." },
    { id: "ex_245", label: "Barbell Row", muscleGroups: ["Back", "Lats", "Rhomboids"], type: "compound", equipment: "Barbell", mechanic: "pull", level: "intermediate", isBodyweight: false, kCalBurned: 7, instructions: "Hinge forward, row barbell to lower chest, control descent." },
    { id: "ex_246", label: "Single-Arm Dumbbell Row", muscleGroups: ["Back", "Lats"], type: "compound", equipment: "Dumbbell / Bench", mechanic: "pull", level: "beginner", isBodyweight: false, kCalBurned: 6, instructions: "Knee and hand on bench, row dumbbell to torso, lower slowly." },
    { id: "ex_247", label: "Back Squat", muscleGroups: ["Quads", "Glutes", "Hamstrings"], type: "compound", equipment: "Barbell / Rack", mechanic: "squat", level: "intermediate", isBodyweight: false, kCalBurned: 8, instructions: "Bar on shoulders, squat down until thighs parallel, drive up through heels." },
    { id: "ex_248", label: "Romanian Deadlift", muscleGroups: ["Hamstrings", "Glutes", "Lower Back"], type: "compound", equipment: "Barbell / Dumbbells", mechanic: "hinge", level: "intermediate", isBodyweight: false, kCalBurned: 7, instructions: "Hinge at hips, lower bar along legs, keep back neutral, return to stand." },
    { id: "ex_249", label: "Walking Lunge", muscleGroups: ["Quads", "Glutes", "Hamstrings"], type: "compound", equipment: "Bodyweight / Dumbbells", mechanic: "lunge", level: "beginner", isBodyweight: true, kCalBurned: 6, instructions: "Step forward into lunge, lower back knee near ground, drive forward to next step." },
    { id: "ex_250", label: "Overhead Press", muscleGroups: ["Shoulders", "Front Delts", "Traps"], type: "compound", equipment: "Barbell / Dumbbells", mechanic: "push", level: "intermediate", isBodyweight: false, kCalBurned: 7, instructions: "Press weight overhead from shoulders, control descent." },
    { id: "ex_251", label: "Lateral Raise", muscleGroups: ["Shoulders", "Side Delts"], type: "isolation", equipment: "Dumbbells", mechanic: "push", level: "beginner", isBodyweight: false, kCalBurned: 5, instructions: "Raise dumbbells to side until shoulders, lower slowly." },
    { id: "ex_252", label: "Face Pull", muscleGroups: ["Shoulders", "Rear Delts", "Traps"], type: "isolation", equipment: "Cable Machine", mechanic: "pull", level: "intermediate", isBodyweight: false, kCalBurned: 5, instructions: "Pull rope to forehead height, elbows high, squeeze rear delts." },
    { id: "ex_253", label: "Barbell Curl", muscleGroups: ["Biceps"], type: "isolation", equipment: "Barbell", mechanic: "pull", level: "beginner", isBodyweight: false, kCalBurned: 5, instructions: "Curl barbell up to shoulders, control down." },
    { id: "ex_254", label: "Hammer Curl", muscleGroups: ["Biceps", "Brachialis"], type: "isolation", equipment: "Dumbbells", mechanic: "pull", level: "beginner", isBodyweight: false, kCalBurned: 5, instructions: "Curl dumbbells with palms facing each other, control down." },
    { id: "ex_255", label: "Tricep Rope Pushdown", muscleGroups: ["Triceps"], type: "isolation", equipment: "Cable Machine", mechanic: "push", level: "beginner", isBodyweight: false, kCalBurned: 5, instructions: "Push rope down until arms fully extended, squeeze triceps." },
    { id: "ex_256", label: "Dips", muscleGroups: ["Triceps", "Chest", "Front Delts"], type: "compound", equipment: "Dip Bars", mechanic: "push", level: "intermediate", isBodyweight: true, kCalBurned: 6, instructions: "Lower body until elbows ~90°, press back up." },
    { id: "ex_257", label: "Plank", muscleGroups: ["Abs", "Core"], type: "isolation", equipment: "Bodyweight", mechanic: "hold", level: "beginner", isBodyweight: true, kCalBurned: 4, instructions: "Hold body in straight line on forearms and toes, engage core." },
    { id: "ex_258", label: "Side Plank", muscleGroups: ["Obliques", "Core"], type: "isolation", equipment: "Bodyweight", mechanic: "hold", level: "intermediate", isBodyweight: true, kCalBurned: 4, instructions: "Lie on side, lift hips, hold straight line, engage obliques." },
    { id: "ex_259", label: "Mountain Climbers", muscleGroups: ["Core", "Cardio"], type: "compound", equipment: "Bodyweight", mechanic: "dynamic", level: "beginner", isBodyweight: true, kCalBurned: 6, instructions: "In plank position, alternate knees toward chest quickly." },
    { id: "ex_260", label: "Lat Pulldown", muscleGroups: ["Back", "Lats"], type: "compound", equipment: "Cable Machine", mechanic: "pull", level: "beginner", isBodyweight: false, kCalBurned: 6, instructions: "Pull bar to upper chest, squeeze lats, control ascent." },
    { id: "ex_261", label: "Inverted Row", muscleGroups: ["Back", "Rhomboids"], type: "compound", equipment: "Barbell / Suspension Trainer", mechanic: "pull", level: "beginner", isBodyweight: true, kCalBurned: 5, instructions: "Pull chest to bar while keeping body straight, lower slowly." },
    { id: "ex_262", label: "T-Bar Row", muscleGroups: ["Back", "Lats", "Rear Delts"], type: "compound", equipment: "T-Bar / Barbell", mechanic: "pull", level: "intermediate", isBodyweight: false, kCalBurned: 7, instructions: "Row weight to chest with bent-over posture, control down." },
    { id: "ex_263", label: "Front Squat", muscleGroups: ["Quads", "Glutes", "Core"], type: "compound", equipment: "Barbell", mechanic: "squat", level: "intermediate", isBodyweight: false, kCalBurned: 8, instructions: "Barbell on front shoulders, squat down, drive up through heels." },
    { id: "ex_264", label: "Bulgarian Split Squat", muscleGroups: ["Quads", "Glutes"], type: "compound", equipment: "Dumbbells / Bodyweight", mechanic: "lunge", level: "intermediate", isBodyweight: true, kCalBurned: 7, instructions: "Back foot on bench, front leg squats down, push through heel to stand." },
    { id: "ex_265", label: "Leg Press", muscleGroups: ["Quads", "Glutes", "Hamstrings"], type: "compound", equipment: "Leg Press Machine", mechanic: "push", level: "beginner", isBodyweight: false, kCalBurned: 7, instructions: "Push platform with feet shoulder-width, lower slowly, extend fully." },
    { id: "ex_266", label: "Calf Raise", muscleGroups: ["Calves"], type: "isolation", equipment: "Bodyweight / Machine", mechanic: "push", level: "beginner", isBodyweight: true, kCalBurned: 4, instructions: "Raise heels as high as possible, lower slowly." },
    { id: "ex_267", label: "Arnold Press", muscleGroups: ["Shoulders", "Front Delts", "Side Delts"], type: "compound", equipment: "Dumbbells", mechanic: "push", level: "intermediate", isBodyweight: false, kCalBurned: 7, instructions: "Start palms facing body, rotate while pressing dumbbells overhead." },
    { id: "ex_268", label: "Front Raise", muscleGroups: ["Shoulders", "Front Delts"], type: "isolation", equipment: "Dumbbells / Plate", mechanic: "push", level: "beginner", isBodyweight: false, kCalBurned: 5, instructions: "Raise weight in front to shoulder height, lower slowly." },
    { id: "ex_269", label: "Reverse Pec Deck", muscleGroups: ["Rear Delts", "Upper Back"], type: "isolation", equipment: "Machine", mechanic: "pull", level: "beginner", isBodyweight: false, kCalBurned: 5, instructions: "Sit facing pad, pull handles back squeezing rear delts." },
    { id: "ex_270", label: "Incline Dumbbell Curl", muscleGroups: ["Biceps"], type: "isolation", equipment: "Dumbbells / Bench", mechanic: "pull", level: "intermediate", isBodyweight: false, kCalBurned: 5, instructions: "Sit on incline bench, curl dumbbells up, control down." },
    { id: "ex_271", label: "Concentration Curl", muscleGroups: ["Biceps"], type: "isolation", equipment: "Dumbbell", mechanic: "pull", level: "beginner", isBodyweight: false, kCalBurned: 4, instructions: "Sit, elbow on inner thigh, curl dumbbell slowly, squeeze bicep." },
    { id: "ex_272", label: "Overhead Dumbbell Extension", muscleGroups: ["Triceps"], type: "isolation", equipment: "Dumbbell", mechanic: "push", level: "intermediate", isBodyweight: false, kCalBurned: 5, instructions: "Hold dumbbell overhead, lower behind head, extend arms up." },
    { id: "ex_273", label: "Close-Grip Bench Press", muscleGroups: ["Triceps", "Chest"], type: "compound", equipment: "Barbell", mechanic: "push", level: "intermediate", isBodyweight: false, kCalBurned: 7, instructions: "Lie on bench, grip bar narrow, press up, control down." },
    { id: "ex_274", label: "Incline Dumbbell Press", muscleGroups: ["Chest", "Upper Chest"], type: "compound", equipment: "Dumbbells / Bench", mechanic: "push", level: "intermediate", isBodyweight: false, kCalBurned: 7, instructions: "Press dumbbells up from incline bench, control down." },
    { id: "ex_275", label: "Chest Fly", muscleGroups: ["Chest"], type: "isolation", equipment: "Dumbbells / Bench", mechanic: "fly", level: "beginner", isBodyweight: false, kCalBurned: 6, instructions: "Arms wide, bring dumbbells together over chest, control down." },
    { id: "ex_276", label: "Push-Up", muscleGroups: ["Chest", "Triceps", "Front Delts"], type: "compound", equipment: "Bodyweight", mechanic: "push", level: "beginner", isBodyweight: true, kCalBurned: 5, instructions: "Hands shoulder-width, lower chest to floor, press back up." },
    { id: "ex_277", label: "Hanging Knee Raise", muscleGroups: ["Abs", "Hip Flexors"], type: "isolation", equipment: "Pull-Up Bar", mechanic: "lift", level: "intermediate", isBodyweight: true, kCalBurned: 6, instructions: "Hang from bar, lift knees to chest, lower slowly." },
    { id: "ex_278", label: "Cable Crunch", muscleGroups: ["Abs"], type: "isolation", equipment: "Cable Machine", mechanic: "crunch", level: "beginner", isBodyweight: false, kCalBurned: 5, instructions: "Kneel facing cable, crunch down, squeeze abs, control up." },
    { id: "ex_279", label: "V-Up", muscleGroups: ["Abs", "Hip Flexors"], type: "isolation", equipment: "Bodyweight", mechanic: "lift", level: "intermediate", isBodyweight: true, kCalBurned: 6, instructions: "Lie down, lift legs and torso simultaneously to form a V, lower slowly." },
    { id: "ex_280", label: "Pull-Up", muscleGroups: ["Back", "Lats", "Biceps"], type: "compound", equipment: "Pull-Up Bar", mechanic: "pull", level: "intermediate", isBodyweight: true, kCalBurned: 8, instructions: "Hang from bar, pull chin above bar, lower with control." },
    { id: "ex_281", label: "Chin-Up", muscleGroups: ["Back", "Biceps"], type: "compound", equipment: "Pull-Up Bar", mechanic: "pull", level: "intermediate", isBodyweight: true, kCalBurned: 8, instructions: "Palms facing you, pull chin above bar, lower slowly." },
    { id: "ex_282", label: "Single-Arm Dumbbell Row", muscleGroups: ["Back", "Lats", "Rear Delts"], type: "compound", equipment: "Dumbbell / Bench", mechanic: "pull", level: "beginner", isBodyweight: false, kCalBurned: 6, instructions: "Place knee on bench, row dumbbell to torso, lower slowly." },
    { id: "ex_283", label: "Romanian Deadlift", muscleGroups: ["Hamstrings", "Glutes", "Lower Back"], type: "compound", equipment: "Barbell / Dumbbells", mechanic: "hinge", level: "intermediate", isBodyweight: false, kCalBurned: 8, instructions: "Keep slight bend in knees, hinge at hips, lower weight, squeeze glutes up." },
    { id: "ex_284", label: "Walking Lunge", muscleGroups: ["Quads", "Glutes", "Hamstrings"], type: "compound", equipment: "Bodyweight / Dumbbells", mechanic: "lunge", level: "beginner", isBodyweight: true, kCalBurned: 7, instructions: "Step forward, bend knees to 90°, push off front foot, alternate." },
    { id: "ex_285", label: "Sumo Deadlift", muscleGroups: ["Quads", "Glutes", "Hamstrings", "Back"], type: "compound", equipment: "Barbell", mechanic: "hinge", level: "intermediate", isBodyweight: false, kCalBurned: 9, instructions: "Wide stance, pull barbell from floor keeping back straight." },
    { id: "ex_286", label: "Step-Up", muscleGroups: ["Quads", "Glutes"], type: "compound", equipment: "Bodyweight / Dumbbells / Bench", mechanic: "push", level: "beginner", isBodyweight: true, kCalBurned: 6, instructions: "Step onto bench, drive through heel, step down, alternate legs." },
    { id: "ex_287", label: "Dumbbell Lateral Raise", muscleGroups: ["Shoulders", "Side Delts"], type: "isolation", equipment: "Dumbbells", mechanic: "push", level: "beginner", isBodyweight: false, kCalBurned: 5, instructions: "Raise dumbbells sideways to shoulder height, lower slowly." },
    { id: "ex_288", label: "Overhead Press (Barbell)", muscleGroups: ["Shoulders", "Traps", "Triceps"], type: "compound", equipment: "Barbell", mechanic: "push", level: "intermediate", isBodyweight: false, kCalBurned: 7, instructions: "Press bar overhead from shoulders, lower slowly." },
    { id: "ex_289", label: "Shrugs", muscleGroups: ["Traps"], type: "isolation", equipment: "Dumbbells / Barbell", mechanic: "lift", level: "beginner", isBodyweight: false, kCalBurned: 4, instructions: "Lift shoulders toward ears, squeeze at top, lower slowly." },
    { id: "ex_290", label: "Barbell Curl", muscleGroups: ["Biceps"], type: "isolation", equipment: "Barbell", mechanic: "pull", level: "beginner", isBodyweight: false, kCalBurned: 5, instructions: "Curl bar to shoulders, control down." },
    { id: "ex_291", label: "Hammer Curl", muscleGroups: ["Biceps", "Forearms"], type: "isolation", equipment: "Dumbbells", mechanic: "pull", level: "beginner", isBodyweight: false, kCalBurned: 5, instructions: "Curl dumbbells with neutral grip, control down." },
    { id: "ex_292", label: "Tricep Dips", muscleGroups: ["Triceps", "Chest", "Front Delts"], type: "compound", equipment: "Parallel Bars / Bench", mechanic: "push", level: "beginner", isBodyweight: true, kCalBurned: 6, instructions: "Lower body by bending elbows, push back up." },
    { id: "ex_293", label: "Cable Tricep Pushdown", muscleGroups: ["Triceps"], type: "isolation", equipment: "Cable Machine", mechanic: "push", level: "beginner", isBodyweight: false, kCalBurned: 5, instructions: "Push bar down until arms fully extended, control up." },
    { id: "ex_294", label: "Decline Bench Press", muscleGroups: ["Chest", "Lower Chest", "Triceps"], type: "compound", equipment: "Barbell / Dumbbells", mechanic: "push", level: "intermediate", isBodyweight: false, kCalBurned: 7, instructions: "Press weight from decline bench, lower under control." },
    { id: "ex_295", label: "Cable Crossover", muscleGroups: ["Chest"], type: "isolation", equipment: "Cable Machine", mechanic: "fly", level: "intermediate", isBodyweight: false, kCalBurned: 6, instructions: "Pull cables together in front of chest, control back." },
    { id: "ex_296", label: "Diamond Push-Up", muscleGroups: ["Chest", "Triceps", "Front Delts"], type: "compound", equipment: "Bodyweight", mechanic: "push", level: "intermediate", isBodyweight: true, kCalBurned: 6, instructions: "Hands form diamond, lower chest to hands, press up." },
    { id: "ex_297", label: "Burpee", muscleGroups: ["Full Body", "Cardio"], type: "compound", equipment: "Bodyweight", mechanic: "dynamic", level: "beginner", isBodyweight: true, kCalBurned: 10, instructions: "Squat, kick feet back, push-up, jump up, repeat." },
    { id: "ex_298", label: "Kettlebell Swing", muscleGroups: ["Glutes", "Hamstrings", "Back", "Core"], type: "compound", equipment: "Kettlebell", mechanic: "swing", level: "intermediate", isBodyweight: false, kCalBurned: 9, instructions: "Hinge at hips, swing kettlebell to shoulder height, control down." },
    { id: "ex_299", label: "Clean and Press", muscleGroups: ["Full Body"], type: "compound", equipment: "Barbell / Dumbbells", mechanic: "lift", level: "advanced", isBodyweight: false, kCalBurned: 12, instructions: "Lift weight from floor to shoulders, press overhead, control down." },
    { id: "ex_300", label: "Thruster", muscleGroups: ["Quads", "Glutes", "Shoulders", "Core"], type: "compound", equipment: "Barbell / Dumbbells", mechanic: "squat + press", level: "intermediate", isBodyweight: false, kCalBurned: 10, instructions: "Front squat into overhead press, extend fully, lower with control." },
