...
export default class NutritionRouter {
    ...
    static init() {
        ...
        this.nutritionRouter.post("/foods/other-user/:id", tokenAuthorization, userAuthorization, asyncHandler(NutritionFoodsController.otherUserFoods));
        ...
        this.nutritionRouter.post("/meal-plans-user/:id", tokenAuthorization, userAuthorization, asyncHandler(NutritionMealPlansController.fetchPlans));
        ...
        this.nutritionRouter.post("/meal-plans/clone/:id", tokenAuthorization, userAuthorization, asyncHandler(NutritionMealPlansController.clonePlan));
